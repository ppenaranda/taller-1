...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Counsultar país que representa un atleta");
		
	}
	private void ejecutarPaisDelAtleta()
	{
		String atleta = input("Ingrese el atleta");
		String pais = calculadora.paisAtelta(atleta);
		System.out.println("El país del atleta es:" + pais);
